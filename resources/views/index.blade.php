...
<head>
    ...
    <title>PT ASA NIAGA PRIMA</title>
  ...
  <body>
    ...
    <div class="humberger__menu__wrapper">
      <div class="humberger__menu__logo">
        <a href="#"><img src="{{ asset('frontend/img/asa.png') }}" alt="" /></a>
      </div>
      ...
      <div class="humberger__menu__contact">
        <ul>
          <li><i class="fa fa-envelope"></i> asaprimaniaga@gmail.com</li>
          <!-- <li></li> -->
        </ul>
      </div>
    </div>
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer__about">
              <div class="footer__about__logo">
                <a href="./index.html"><img src="{{ asset('frontend/img/asa.png') }}" alt="" /></a>
              </div>
              <ul>
              <ul>
                <li>Address: Jl. Griya Punto Dewo Indah, Kragilan, Sinduadi, Kec. Mlati, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55284</li>
                <li>Phone: +62 857-7055-3859</li>
                <li>Email: asaprimaniaga@gmail.com</li>
              </ul>
            </div>
          </div>
