...
<title>Products</title>
  ...
  <section class="py-6 px-6 sm:px-8 md:px-16 lg:px-32">
    ...
    <div class="mb-6 ml-10 flex flex-col sm:flex-row justify-between">
      <div>
        <h3 class="font-semibold text-gray-600 text-xl">Product</h3>
      </div>
      <div class="flex">
        <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="text-gray-700 bg-gray-200 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center" type="button">Dropdown button <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
          ...
          <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
              <ul class="py-2 text-sm text-gray-700 aria-labelledby="dropdownDefaultButton">
                <li>
                  <a href="#" class="block px-4 py-2 hover:bg-gray-100">By name(asc)</a>
                </li>
                <li>
                  <a href="#" class="block px-4 py-2 hover:bg-gray-100">By name(desc)</a>
                </li>
                <li>
                  <a href="#" class="block px-4 py-2 hover:bg-gray-100">New</a>
                </li>
                <li>
                  <a href="#" class="block px-4 py-2 hover:bg-gray-100">Old</a>
                </li>
              </ul>
          </div>
          <form action="/product" class="flex flex-row space-x-3 mx-10" method="GET">
            <div class="flex items-center">   
              <input type="text" id="search" name="search" class="bg-neutral-50 border border-gray-300 text-gray-900 focus:shadow-sm focus:shadow-[#EA6C20]/10 focus:border-main focus:ring-0 text-sm rounded-lg block w-full p-2.5" placeholder="Type here..." required="">
              <button type="submit" class="p-2.5 ms-2 text-sm font-medium text-white bg-green-500 rounded-lg border hover:bg-main">
