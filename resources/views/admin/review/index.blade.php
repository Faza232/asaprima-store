...
<div class="px-4 md:px-6 container w-full">
    <div class="border-b-2">
      <h1 class="font-semibold text-2xl mb-2">Ulasan</h1>
    </div>
    <!-- Upload Button -->
    <a href="/dashboard/review/create" class="my-4 bg-main hover:bg-third text-white py-2 px-4 rounded-lg inline-flex items-center">
                ...
                <tr class="odd:bg-white even:bg-gray-50 border-b">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex flex-row space-x-4">
                            {{-- Edit Button --}}
                            <a href="{{ route('review.edit', $review->id) }}" class="flex items-center px-0 py-2 text-sm font-semibold transition-all ease-nav-brand text-slate-500 hover:text-slate-800">
