...
<div class="container w-full rounded-lg bg-white shadow-lg p-4 md:p-6">
  ...
  <div class="block border max-w-3xl rounded-lg p-6 my-4">
    <form method="POST" action="/dashboard/certificate" enctype="multipart/form-data">
      @csrf
      {{-- Nama Sertifikat --}}
      <div class="mb-6">
      ...
      <div class="mb-6">
        ...
        <input type="text" id="year" name="year" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
      </div>
      {{-- Slug --}}
