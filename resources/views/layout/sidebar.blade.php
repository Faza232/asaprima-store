...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="my-4 ml-4 px-3 py-4 rounded-xl shadow-lg h-max overflow-y-auto bg-neutral-50 border border-gray-200">
      ...
      <ul class="space-y-2 font-medium">
         <li>
            <a href="/dashboard/produk" class="sidenav-link flex items-center p-2 text-gray-900 rounded-lg hover:bg-second group">
         ...
         <li>
            <a href="/dashboard/kategori" class="sidenav-link flex items-center p-2 text-gray-900 rounded-lg hover:bg-second group">
               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="sidenav-icon w-5 h-5 text-third group-hover:text-main transition duration-75">
         ...
         <li>
            <a href="/dashboard/artikel" class="sidenav-link flex items-center p-2 text-gray-900 rounded-lg hover:bg-second group">
               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="sidenav-icon w-5 h-5 text-third group-hover:text-main transition duration-75">
         ...
         <li>
            <a href="/dashboard/ulasan" class="sidenav-link flex items-center p-2 text-gray-900 rounded-lg hover:bg-second group">
               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="sidenav-icon w-5 h-5 text-third group-hover:text-main transition duration-75">
         ...
         <li>
            <a href="/dashboard/sertifikat" class="sidenav-link flex items-center p-2 text-gray-900 rounded-lg hover:bg-second group">
               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="sidenav-icon w-5 h-5 text-third group-hover:text-main transition duration-75">
